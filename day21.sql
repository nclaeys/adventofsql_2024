...
select year, q, quarter_result, previous_quarter, (quarter_result - previous_quarter)/previous_quarter as growth_rate from with_previous_amount order by growth_rate desc NULLS last;
